...
<body>
	...
	<form action="updatePro.jsp" method="post">
		<input type="hidden" name="num" value="<%=num %>"> <!-- 쿼리문으로 넘길때쓸 글번호 히든으로숨김 -->
		...
		<table border="1">
			...
			<tr>
				<th>내용</th>
				<td><textarea rows="13" cols="40" name="content" required><%=boardVo.getContent() %></textarea></td> <!-- 텍스트에어리어는 태그의시작과끝사이가 밸류. --> 
			</tr>
			<tr>
				<td colspan="2">
					<input type="submit" value="수정하기쓰">
