    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PJoinSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(password.equals(passwordcheck)){ // 비밀번호 체크되면
                    ...
                    new NetworkPersonInsert().execute(id,password,name,birth,sex,email,tel);

                    Toast myToast = Toast.makeText(PersonJoin.this ,"환영합니다." , Toast.LENGTH_SHORT);
                    myToast.show();
                    Intent intent = new Intent(PersonJoin.this, MainActivity.class);
